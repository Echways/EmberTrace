...
public sealed class TracingSession : IDisposable
{
    ...
    {
        return new AsyncScope(id, _profiler);
    }

    public long NewFlowId()
    {
        return _profiler.NewFlowId();
    }

    public long FlowStartNew(int id)
    {
        return _profiler.FlowStartNew(id);
    }

    public FlowScope Flow(int id)
    {
        return _profiler.Flow(id);
    }
    ...
    {
        _profiler.Instant(id);
    }

    public void Counter(int id, long value)
    {
        _profiler.Counter(id, value);
    }

    public FlowHandle FlowStartNewHandle(int id)
    {
        return _profiler.FlowStartNewHandle(id);
    }

    public void FlowEnd(FlowHandle handle)
    {
        handle.End();
    }

    public void FlowStep(FlowHandle handle)
    {
        handle.Step();
    }

    public ITraceMetadataProvider CreateMetadata()
    {
        return _profiler.Metadata;
    }
}