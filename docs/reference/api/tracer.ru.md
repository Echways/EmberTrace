...
- **Риск коллизий**: хэш-пространство содержит ~2,1 млрд значений. По парадоксу дней рождения вероятность первой коллизии достигает 50% примерно на **46 000 уникальных имён** — это реальный порог в крупном монорепозитории.
...
|----------|-----------|--------------|
| `Warn` | Выводит `Trace.TraceWarning` | **Да** (все конфигурации) |
